  ...
  const prompt = useMemo(
    () =>
      [
        ...
        `Defining visual rules:`,
        ...theme.designRules.map((rule) => `- ${rule}.`),
        `Avoid: ${theme.avoid.join("; ")}.`,
        `Treat this as one coherent skin with one canonical palette; do not invent`,
        `alternate colorways or mix in visual rules from another theme.`,
        ``,
